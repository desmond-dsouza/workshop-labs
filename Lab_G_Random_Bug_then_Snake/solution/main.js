...
var $author$project$Lib$WkApp$DownArrow = {$: 'DownArrow'};
var $author$project$Lib$WkApp$Key = function (a) {
	return {$: 'Key', a: a};
};
var $author$project$Lib$WkApp$LeftArrow = {$: 'LeftArrow'};
var $author$project$Lib$WkApp$RightArrow = {$: 'RightArrow'};
var $author$project$Lib$WkApp$UpArrow = {$: 'UpArrow'};
var $author$project$Lib$WkApp$WentDown = {$: 'WentDown'};
var $author$project$Lib$WkApp$WentUp = {$: 'WentUp'};
var $author$project$Lib$WkApp$arrowChecker = F5(
...
var $author$project$Lib$WkApp$Down = {$: 'Down'};
var $author$project$Lib$WkApp$JustDown = {$: 'JustDown'};
var $author$project$Lib$WkApp$JustUp = {$: 'JustUp'};
...
var $author$project$Lib$WkApp$insertKeyDict = F3(
				...
				switch (currState.a.a.$) {
					case 'JustDown':
						...
						return A3(
							...
							function () {
								if (action.$ === 'WentDown') {
									return _Utils_Tuple2($author$project$Lib$WkApp$JustDown, false);
								} else {
									return _Utils_Tuple2($author$project$Lib$WkApp$JustDown, true);
								}
							}(),
							dict);
					case 'Down':
						...
						return A3(
							...
							function () {
								if (action.$ === 'WentDown') {
									return _Utils_Tuple2($author$project$Lib$WkApp$Down, false);
								} else {
									return _Utils_Tuple2($author$project$Lib$WkApp$JustUp, false);
								}
							}(),
							dict);
					case 'Up':
					...
					default:
						...
						return A3(
							...
							function () {
								if (action.$ === 'WentDown') {
									return _Utils_Tuple2($author$project$Lib$WkApp$JustUp, true);
								} else {
									return _Utils_Tuple2($author$project$Lib$WkApp$JustUp, false);
								}
							}(),
...
var $author$project$Lib$WkApp$Up = {$: 'Up'};
var $elm$core$Char$toUpper = _Char_toUpper;
var $author$project$Lib$WkApp$keyCheckerFunction = F2(
	function (dict, key) {
		var kc = function () {
			switch (key.$) {
				case 'Key':
		...
		if (state.$ === 'Just') {
			switch (state.a.a.$) {
				case 'JustDown':
					var _v1 = state.a;
					var _v2 = _v1.a;
					return $author$project$Lib$WkApp$JustDown;
				case 'Down':
					var _v3 = state.a;
					var _v4 = _v3.a;
					return $author$project$Lib$WkApp$Down;
				case 'JustUp':
					var _v5 = state.a;
					var _v6 = _v5.a;
					return $author$project$Lib$WkApp$JustUp;
				default:
					var _v7 = state.a;
					var _v8 = _v7.a;
					return $author$project$Lib$WkApp$Up;
			}
		} else {
			return $author$project$Lib$WkApp$Up;
		}
...
var $author$project$Lib$WkApp$filterHelper = F2(
	function (key, action) {
		if (action.a.$ === 'Up') {
			var _v1 = action.a;
			return false;
...
var $author$project$Lib$WkApp$maintainHelper = F2(
	function (key, action) {
		if (!action.b) {
			switch (action.a.$) {
				case 'JustUp':
					var _v1 = action.a;
					return _Utils_Tuple2($author$project$Lib$WkApp$Up, false);
				case 'Up':
					var _v3 = action.a;
					return _Utils_Tuple2($author$project$Lib$WkApp$Up, false);
				case 'JustDown':
...
var $author$project$Lib$WkApp$maintainKeyDict = function (dict) {
	return A2(
		$elm$core$Dict$filter,
		$author$project$Lib$WkApp$filterHelper,
		A2($elm$core$Dict$map, $author$project$Lib$WkApp$maintainHelper, dict));
};
var $elm$time$Time$posixToMillis = function (_v0) {
	var millis = _v0.a;
	return millis;
};
var $author$project$Lib$WkApp$subtractTimeSeconds = F2(
	function (t1, t0) {
		return ($elm$time$Time$posixToMillis(t1) - $elm$time$Time$posixToMillis(t0)) / 1000;
	});
var $author$project$Lib$WkApp$hiddenTickUpdate = F3(
		...
		switch (msg.$) {
			case 'UserMsg':
				...
				return _Utils_Tuple2(
					...
					A2($elm$core$Platform$Cmd$map, $author$project$Lib$WkApp$UserMsg, newUserCmds));
			case 'InitTime':
				var t = msg.a;
				return _Utils_Tuple2(
					_Utils_Tuple2(
			...
			case 'TickTime':
				var t = msg.a;
				var timeInSeconds = A2($author$project$Lib$WkApp$subtractTimeSeconds, t, hiddenModel.initT);
				var keyChecker = $author$project$Lib$WkApp$keyCheckerFunction(hiddenModel.keys);
				var wasd = A5(
					$author$project$Lib$WkApp$arrowChecker,
					keyChecker,
					$author$project$Lib$WkApp$Key('w'),
					$author$project$Lib$WkApp$Key('s'),
					$author$project$Lib$WkApp$Key('a'),
					$author$project$Lib$WkApp$Key('d'));
				var arrowKeys = A5($author$project$Lib$WkApp$arrowChecker, keyChecker, $author$project$Lib$WkApp$UpArrow, $author$project$Lib$WkApp$DownArrow, $author$project$Lib$WkApp$LeftArrow, $author$project$Lib$WkApp$RightArrow);
				var _v3 = A2(
					userUpdate,
					A2(
						hiddenModel.tick,
				...
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							hiddenModel,
							{
								keys: $author$project$Lib$WkApp$maintainKeyDict(hiddenModel.keys)
							})),
					A2($elm$core$Platform$Cmd$map, $author$project$Lib$WkApp$UserMsg, newUserCmds));
			case 'KeyDown':
				var keyCode = msg.a;
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							hiddenModel,
							{
								keys: A3($author$project$Lib$WkApp$insertKeyDict, hiddenModel.keys, keyCode, $author$project$Lib$WkApp$WentDown)
							})),
					$elm$core$Platform$Cmd$none);
			default:
				var keyCode = msg.a;
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							hiddenModel,
							{
								keys: A3($author$project$Lib$WkApp$insertKeyDict, hiddenModel.keys, keyCode, $author$project$Lib$WkApp$WentUp)
							})),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Lib$WkApp$initHiddenModel = function (tick) {
	return {
...
var $author$project$Lib$WkApp$KeyDown = function (a) {
	return {$: 'KeyDown', a: a};
};
var $author$project$Lib$WkApp$KeyUp = function (a) {
	return {$: 'KeyUp', a: a};
};
var $author$project$Lib$WkApp$TickTime = function (a) {
	return {$: 'TickTime', a: a};
};
...
var $author$project$Lib$WkApp$subsThrottle = function (delta) {
	return _List_fromArray(
		[
			$elm$browser$Browser$Events$onKeyUp(
			A2(
				$elm$json$Json$Decode$map,
				$author$project$Lib$WkApp$KeyUp,
				A2($elm$json$Json$Decode$field, 'keyCode', $elm$json$Json$Decode$int))),
			$elm$browser$Browser$Events$onKeyDown(
			A2(
				$elm$json$Json$Decode$map,
				$author$project$Lib$WkApp$KeyDown,
				A2($elm$json$Json$Decode$field, 'keyCode', $elm$json$Json$Decode$int))),
			function () {
			switch (delta.$) {
				case 'Max':
					return $elm$browser$Browser$Events$onAnimationFrame($author$project$Lib$WkApp$TickTime);
				case 'Every':
					var t = delta.a;
					return A2($elm$time$Time$every, t, $author$project$Lib$WkApp$TickTime);
				default:
...
var $author$project$Lib$WkApp$wkGameApp = F3(
		...
		return $MacCASOutreach$graphicsvg$GraphicSVG$ellieApp(
			{
				init: function (flags) {
					...
					return _Utils_Tuple2(
						_Utils_Tuple2(
							userInitModel,
							$author$project$Lib$WkApp$initHiddenModel(tickMsg)),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2($elm$core$Task$perform, $author$project$Lib$WkApp$InitTime, $elm$time$Time$now),
									A2($elm$core$Platform$Cmd$map, $author$project$Lib$WkApp$UserMsg, userInitCmds)
								])));
				},
				subscriptions: function (_v0) {
					...
					return $elm$core$Platform$Sub$batch(
						A2(
							...
							A2(
								$elm$core$Platform$Sub$map,
								$author$project$Lib$WkApp$UserMsg,
								userSubs(userModel)),
							$author$project$Lib$WkApp$subsThrottle(tickRate)));
				},
				update: $author$project$Lib$WkApp$hiddenTickUpdate(userUpdate),
				view: function (_v1) {
					var userModel = _v1.a;
					var userViewE = userView(userModel);
					return {
						body: A2($MacCASOutreach$graphicsvg$GraphicSVG$mapCollage, $author$project$Lib$WkApp$UserMsg, userViewE.body),
...
var $author$project$Main$initialModel = {
	food: _Utils_Tuple2((($author$project$Grid$grid.numColumns / 2) | 0) - 1, 0),
	snake: {
		body: _List_fromArray(
			[
				_Utils_Tuple2(-3, 0),
...
var $author$project$Main$decodeKeys = function (keyF) {
	return (_Utils_eq(
		...
		keyF($author$project$Lib$WkApp$Space),
		$author$project$Lib$WkApp$Down)) ? $elm$core$Maybe$Just($author$project$Lib$WkApp$Space) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$LeftArrow),
		$author$project$Lib$WkApp$JustDown) ? $elm$core$Maybe$Just($author$project$Lib$WkApp$LeftArrow) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$RightArrow),
		$author$project$Lib$WkApp$JustDown) ? $elm$core$Maybe$Just($author$project$Lib$WkApp$RightArrow) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$UpArrow),
		$author$project$Lib$WkApp$JustDown) ? $elm$core$Maybe$Just($author$project$Lib$WkApp$UpArrow) : (_Utils_eq(
...
var $author$project$Types$NewFood = function (a) {
	return {$: 'NewFood', a: a};
};
...
var $author$project$Main$randomFoodCmd = function () {
			...
			function () {
				...
				switch (_v0.$) {
					case 'Eating':
						return $elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[$author$project$Main$randomFoodCmd, $author$project$Main$playSuccessCmd]));
					case 'HitSelf':
					...
					case 'HitSelf':
						if ((_v2.b.$ === 'Just') && (_v2.b.a.$ === 'Space')) {
							...
							return _Utils_Tuple2(
								...
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[$author$project$Main$randomFoodCmd, $author$project$Main$playStartCmd])));
						} else {
							var _v7 = _v2.a;
...
var $author$project$Main$main = A3(
	...
	$author$project$Lib$WkApp$Every(200),
